// Wedding Website Server with MongoDB and API endpoints
...
if (fs.existsSync(path.join(__dirname, 'google-sheets-endpoint.js'))) {
    const googleSheetsRouter = require('./google-sheets-endpoint');
    app.use('/api/google-sheets', authenticateToken, googleSheetsRouter);
}
